                ...
                <form onSubmit={handleSubmit} className="p-8">
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none transitions-all shadow-sm"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none transitions-all shadow-sm appearance-none"
                                    >
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-accent/20 focus:border-accent outline-none transitions-all shadow-sm h-32 resize-none"
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="px-8 py-3 bg-primary hover:bg-secondary text-white rounded-xl font-bold shadow-lg transition-all transform active:scale-95 flex items-center gap-2"
                        >
