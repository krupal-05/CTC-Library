            ...
            <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="bg-primary rounded-lg shadow-lg text-white p-8 border-b-4 border-secondary">
                        <div className="mb-8">
                            ...
                            <ul className="space-y-3">
                                ...
                                <li className="flex items-start gap-3">
                                    <div className="bg-white/10 p-2 rounded-full"><Calendar className="w-5 h-5 text-accent" /></div>
                        ...
                        <div>
                            ...
                            <div className="flex items-start gap-3 cursor-pointer hover:bg-white/10 p-2 -ml-2 rounded transition-colors">
                                ...
                                <a href='https://maps.app.goo.gl/u9EPGvX5QtpTzfTEA?g_st=aw'>
                ...
                <div className="mt-12 mb-8">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold text-gray-800 border-b-4 border-primary inline-block pb-1 uppercase tracking-wider">Latest Events</h2>
                        <p className="text-gray-600 mt-2">Stay updated with the latest events and activities happening at the Library</p>
                    </div>
                        ...
                        {events.map((event) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-black/80 flex flex-col justify-center items-center text-white p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    ...
                                    <span className="text-primary text-xs font-bold bg-white px-4 py-1.5 rounded-full shadow-sm">
                                        View Details
                                    </span>
                                </div>
                            </Link>
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <Link to="/about" className="inline-flex items-center gap-2 text-primary font-bold hover:text-secondary transition-all hover:gap-3">
